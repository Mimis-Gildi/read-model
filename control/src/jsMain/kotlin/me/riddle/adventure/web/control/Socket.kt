...
import me.riddle.adventure.web.model.EVENT_CHANNEL
import me.riddle.adventure.web.model.EVENT_PROTOCOL
...
/** Whatever served the control plane serves `Event Channel`; [EVENT_CHANNEL] there is no second host and no TLS variant of this page. */
private fun controlPlane() = EVENT_PROTOCOL + window.location.host + EVENT_CHANNEL
