...
/**
 * A frame off `Event Channel` [me.riddle.adventure.web.model.EVENT_CHANNEL]. kotlinx.serialization dispatches
 * on the discriminator it wrote itself; nothing here re-derives it.
