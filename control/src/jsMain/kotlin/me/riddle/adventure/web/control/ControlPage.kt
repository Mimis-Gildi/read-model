...
object ControlPage {
    ...
    val performanceTableStatusComponent: HTMLDivElement             = acquirePageHTMLElementById(PERFORMANCE_TABLE_STATUS_MESSAGE)
    val connectionStatusComponent: HTMLDivElement                   = acquirePageHTMLElementById(CONNECTION_STATUS_COMPONENT)
